...
fu.get("/js/jquery.js", fu.staticHandler("./node_debug/js/jquery.js"));
fu.get("/js/jquery.cookie.js", fu.staticHandler("./node_debug/js/jquery.cookie.js"));
fu.get("/js/jquery.treeview.js", fu.staticHandler("./node_debug/js/jquery.treeview.js"));
fu.get("/js/jquery.treeview.async.js", fu.staticHandler("./node_debug/js/jquery.treeview.async.js"));
fu.get("/js/treeview-default.gif", fu.staticHandler("./node_debug/js/treeview-default.gif"));
fu.get("/js/treeview-default-line.gif", fu.staticHandler("./node_debug/js/treeview-default-line.gif"));
fu.get("/js/jquery.ui.min.js", fu.staticHandler("./node_debug/js/jquery.ui.min.js"));
fu.get("/js/autoresize.jquery.min.js", fu.staticHandler("./node_debug/js/autoresize.jquery.min.js"));
fu.get("/js/debug.js", fu.staticHandler("./node_debug/js/debug.js"));
